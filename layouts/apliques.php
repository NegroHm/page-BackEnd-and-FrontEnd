...
<head>
    ...
    <link rel="stylesheet" href="../public/CSS/apliques.css">

    <title>Apliques Decorativos</title>
</head>
...
<body>
        ...
        <div class="container">
          <div class="row">
            ...
            <?php
              ...
              $consulta= "SELECT * FROM `productos` WHERE `tipo_de_producto` = 'aplique'";
              mysqli_select_db($conexion, "mueblesmedina");
              $datos= mysqli_query($conexion, $consulta);
              while ($reg = mysqli_fetch_array($datos)) { ?>
    
                <!-- card: -->
                <div class="card col-sm-12 col-md-6 col-lg-3 bloque1">
    ...
    <footer>
        ...
        <div class="text">
            <p>El compromiso de la empresa es que en la realización de cada trabajo quede plasmado el espíritu de ser pieza única creada a mano y con carácter propio, ya que cada pieza es de particular creación de un buen hacer artesano. Podemos desarrollar sus propias creaciones y materializar sus ideas. Domicilio: Manuel A. Sáez 1090, Las Heras.</p>
