...
<html lang="en">
    ...
    <body>
        ...
        $tipo_prenda=$datos["tipo_de_producto"];
        $marca=$datos["nombre"];
        $precio=$datos["precio"];
        $imagen=$datos['imagen'];?>
        <h2>Modificar</h2>
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="tipo_de_producto" placeholder="Tipo de Prenda" value="<?php echo "$tipo_prenda"; ?>">
            <label>Nombre</label>
            <input type="text" name="nombre" placeholder="Nombre" value="<?php echo "$marca"; ?>">
            <label>Precio</label>
            <input type="text" name="precio" placeholder="Precio" value="<?php echo "$precio"; ?>">
            <label>Imagen</label>
            <input type="file" name="imagen" placeholder="imagen">
            <input type="submit" name="guardar_cambios" value="Guardar Cambios">
            <button type="submit" name="Cancelar" formaction="pagadmin.php">Cancelar</button>
        </form>
        <?php
        ...
        if(array_key_exists('guardar_cambios',$_POST)){
            ...
            // a) generar la consulta a realizar
             $consulta = "UPDATE productos SET tipo_de_producto='$tipo_prenda', nombre='$marca', precio='$precio', imagen='$imagen' WHERE id=$id";
