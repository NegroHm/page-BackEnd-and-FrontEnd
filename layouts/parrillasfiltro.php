...
<body>
    ...
    <main>
        <div class="maincss">
            ...
            <p>La siguiente lista muestra los datos de las parrillas disponibles.</p>
            <div class="tabla1">
                <table border="1">
                    <tr>
                        <th>ID</th>
    ...
    $consulta="SELECT * FROM productos WHERE tipo_de_producto = 'parrilla'";
