...
<head>
    ...
    <link rel="stylesheet" href="../public/CSS/portones.css">

    <title>Portones</title>
</head>
...
<body>
        ...
        <div class="container">
          <div class="row">
            ...
            <?php
              ...
              $consulta= "SELECT * FROM `productos` WHERE `tipo_de_producto` = 'porton'";
    ...
    <footer>
        ...
        <div class="text">
            <p>El compromiso de la empresa es que en la realización de cada trabajo quede plasmado el espíritu de ser
                pieza única creada a mano y con carácter propio, ya que cada pieza es de particular creación de un buen
                hacer artesano. Podemos desarrollar sus propias creaciones y materializar sus ideas. Domicilio: Manuel
                A. Sáez 1090, Las Heras.</p>
